...
public class ShooterCalculator {
    ...
    private static final LoggedTunableNumber nearVel = new LoggedTunableNumber("Shooter/NearVel", 450.0);
    private static final LoggedTunableNumber midVel = new LoggedTunableNumber("Shooter/MidVel", 500.0);
